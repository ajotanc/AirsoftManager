...
export const TEAMS = [
  ...
  "Kavock",
  "Kimera Airsoft",
  // { label: "1º BAC", value: 1 },
  // { label: "Airsoft Paulo Afonso", value: 2 },
  // { label: "ANAT", value: 3 },
  // { label: "Arcanjo Porto Seguro", value: 4 },
  // { label: "Arcanjos da Chapada", value: 5 },
  // { label: "Arcanjos Soldiers", value: 6 },
  // { label: "Arkanjos", value: 7 },
  // { label: "Black Hawk", value: 8 },
  // { label: "Black Lions", value: 9 },
  // { label: "Black Ops", value: 10 },
  // { label: "Black Skull", value: 11 },
  // { label: "Black Weapon", value: 12 },
  // { label: "Blackout-SE", value: 13 },
  // { label: "Bratva", value: 14 },
  // { label: "Bravo", value: 15 },
  // { label: "Cães Selvagens Airsoft", value: 16 },
  // { label: "Canes", value: 17 },
  // { label: "CAPA", value: 18 },
  // { label: "Carcará", value: 19 },
  // { label: "CAS", value: 20 },
  // { label: "Casal Airsoft - Serrinha", value: 21 },
  // { label: "CAT", value: 22 },
  // { label: "CATA", value: 23 },
  // { label: "Catingueiros Airsoft Lençóis", value: 24 },
  // { label: "CEDAM", value: 25 },
  // { label: "CGAT", value: 26 },
  // { label: "Chakal", value: 27 },
  // { label: "Chivalry", value: 28 },
  // { label: "Cia de Airsoft Delta", value: 29 },
  // { label: "CITE", value: 30 },
  // { label: "Comando Selva", value: 31 },
  // { label: "Corvos de Amargosa", value: 32 },
  // { label: "COTA", value: 33 },
  // { label: "CPAT", value: 34 },
  // { label: "CTA - Petrolina", value: 35 },
  // { label: "Cyrus Company", value: 36 },
  // { label: "DCC -  Corisco do Cumbe", value: 37 },
  // { label: "Delta Force", value: 38 },
  // { label: "Desertores", value: 39 },
  // { label: "DETA", value: 40 },
  // { label: "Dias D'Ávila", value: 41 },
  // { label: "Dinops", value: 42 },
  // { label: "Dragons Tactical", value: 43 },
  // { label: "Drakkar", value: 44 },
  // { label: "E.F.A.S.", value: 45 },
  // { label: "Equipe Arcanjo", value: 46 },
  // { label: "Esquadrão Fantasma", value: 47 },
  // { label: "F.E.A.T.", value: 48 },
  // { label: "FBI", value: 49 },
  // { label: "FEAR", value: 50 },
  // { label: "Fênix", value: 51 },
  // { label: "Fominhas", value: 52 },
  // { label: "Força Tática SSA", value: 53 },
  // { label: "Fortes Airsoft", value: 54 },
  // { label: "Frontline", value: 55 },
  // { label: "G.T.A.A.", value: 56 },
  // { label: "Gladiators", value: 57 },
  // { label: "GOAJ", value: 58 },
  // { label: "Havoc Team Airsoft", value: 59 },
  // { label: "IDFA", value: 60 },
  // { label: "Independente", value: 61 },
  // { label: "Kavock", value: 62 },
  // { label: "Kimera Airsoft", value: 63 },
]